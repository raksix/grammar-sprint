 ...
 * - Only links to routes that exist (`/learn/*`, `/levels/*`); the
 *   review/gate routes land in P24, so misses are reported as plain text.
 */
        ...
        >
          ...
          {finished.missed > 0 ? (
            <p className="quiz-review-note">
              ...
              review deck with its rule tag — re-answer{" "}
